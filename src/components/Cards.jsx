  ...
  return (
    ...
    >
      ...
      <div
        ...
        } lg:mb-2 flex flex-col justify-center h-full`}
      >
       {cardValue?.title &&  <h2
        ...
        <p className="mt-3 font-inter text-md font-normal text-base md:text-[18px]/[1.36] leading-[1.36] md:text-md indent-[16px]">
