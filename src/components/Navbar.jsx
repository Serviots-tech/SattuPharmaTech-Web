...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white  sm:px-20 px-6 dark:bg-black text-xl w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 font-popins font-bold">
