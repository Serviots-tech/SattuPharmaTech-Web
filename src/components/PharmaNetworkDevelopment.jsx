...
export default function PharmaNetworkDevelopment() {
  return (
    <section className="py-20">
      <div className="pt-10 px-6 sm:px-10 md:px-16 lg:px-20 xl:px-10 w-full  mx-auto">
        ...
        <p className="text-gray-600 text-left mb-8 mt-5">
          Our pharma network development includes comprehensive network and consulting services.
          We have specifically designed the services to help startups or pharma Enterprises who
          are looking to explore new markets in the new region within Africa. Or someone from Africa
          who wants to start a new pharmaceutical manufacturing or establish a profitable business
          in India. Here are the services we offer.
        </p>
