...
//           <div className="p-4">
//             <h2 className="text-xl font-poppins mb-4">Contact Us</h2>

//             <div className="space-y-4">
//               <div className="flex flex-col lg:flex-row gap-12">
//               <div>
//                 <p className="font-poppins">
//                   <span className="font-medium">Trusha Gandhi</span>
//                   <span className="text-gray-600 italic ml-2">(Founder)</span>
//                 </p>
//                 <p className="text-gray-800">+91 8980161651</p>
//               </div>

//               <div>
//                 <p className="font-poppins">
//                   <span className="font-medium">Akshat Gandhi</span>
//                   <span className="text-gray-600 italic ml-2">(Co-Founder)</span>
//                 </p>
//                 <p className="text-gray-800">+91 9099019848</p>
//               </div>
//               </div>
//               <div>
//                 <p className="font-poppins">
//                   <span className="font-medium">Saurabh Nayak</span>
//                   <span className="text-gray-600 italic ml-2">- Director (Operations)</span>
//                 </p>
//                 <p className="text-gray-800">+91 9426311821</p>
//               </div>
//               <div className="flex flex-col lg:flex-row gap-12">
//               <div className="mt-6">
...
//                 </p>
//                 <p className="text-gray-800 underline">info@satupharmtech.com</p>
//                 <p className="text-gray-800 underline">business@satupharmtech.com</p>
//               </div>
...
//   return (
//     <div className="pt-10 pb-2 px-6 sm:px-10 md:px-16 lg:px-20 xl:px-10 w-full mx-auto ">
//       <div className="flex flex-col lg:flex-row justify-between space-y-8 lg:space-y-0 gap-12">
//         <div className="max-w-xl">
//           <div className="flex items-center mb-4">
//             <Image
//               src="/assets/BrandLogo.png"
