    ...
    <>
      {!landingPage ? (
        ...
        <>
          ...
          <div className="flex justify-center">
            <div className=" z-20 w-[84vw]  mx-auto grid justify-center xl:-mt-32 lg:-mt-28 md:-mt-28 -mt-32 lg:py-10 bg-[#FFF7E3] rounded-lg shadow-lg p-4 space-x-4 md:space-x-8">
              <div className="bg-[#FFF7E3]">
                <div className="container mx-auto px-4">
                  <div className="flex flex-wrap justify-center items-center text-center gap-6 md:gap-4 ">
                    <h3 className="text-lg md:text-xl font-poppins font-light">
